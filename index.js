function displayQuote(response) {
  ...
  function generateQuote(event) {
    ...
    let context =
      "You are an inspirational quote expert and love to write short quotes. You mission is to generate a quote in basic HTML and separate each line with a <br />. Make sure to follow the user instructions. Do not include a title to the quote";
